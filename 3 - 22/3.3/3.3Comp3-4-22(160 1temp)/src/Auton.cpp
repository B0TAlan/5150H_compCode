...
void right20(){
  aB.OF();
  aC.OF();
  pringle.spinFor(reverse, 2, rotationUnits::rev, 100, velocityUnits::pct);
  driveBase.driveFor(fwd, 35, inches, 200, velocityUnits::pct);
  aL.Min(100, false);
  ...
  aL.Idle(100, false);
  Pid.Turn(247, .45);
  driveBase.driveFor(reverse, 10, inches, 15, velocityUnits::pct);
  aB.CF();
  pringle.spin(reverse, 100, velocityUnits::pct);
}
...
void Skills(){
  ...
  driveBase.driveFor(fwd, -30, inches, 60, velocityUnits::pct);// drives twords the yello mgoal
  driveBase.driveFor(fwd, -14, inches, 20, velocityUnits::pct);// slows down to have yello magoal slide into back lift 
  ...
  driveBase.driveFor(44, inches, 60, velocityUnits::pct);// drives tworads platform
  Pid.Turn(303, .3);
  ...
  Pid.Turn(189, .45);// rotates to face red mgoal
  ...
  driveBase.driveFor(fwd, 9, distanceUnits::in, 25, velocityUnits::pct, false);// slows down in order to not crash
  ...
  //aL.Min(100, false);
  driveBase.driveFor(fwd, -15, distanceUnits::in, 25, velocityUnits::pct);// nessles middle mgoal into bL
  aB.Close();// close back lift 
  Pid.Turn(230, .45);// self correct 
  driveBase.driveFor(fwd, -69, distanceUnits::in, 35, velocityUnits::pct);// drive back to put middle mgoal into the conner next to the blue mgoal
  Pid.Turn(223, .45);
  driveBase.driveFor(fwd, -7, distanceUnits::in, 35, velocityUnits::pct);
  ...
  Pid.Turn(135, .45);// turns to put red mgoal on the plat form
