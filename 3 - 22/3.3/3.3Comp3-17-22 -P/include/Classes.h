...
public:
 void newPid(float target, float kp/*, float kd*/){
    DriveMotors.reset();// reset all motors encoders to 0
    lF.setPosition(0, rotationUnits::deg);
    rF.setPosition(0, rotationUnits::deg);
    float startT = Paincreas.timer(msec); // time when pid starts
    ...
    while(stopPid == false){
      ...
      float leftPut = (kp*rightError);
      float rightPut = (kp*rightError);
      
      std::cout<<"Target = "<<target<<std::endl;
      std::cout<<"CurrentR = "<<rightCurrent<<std::endl;
      std::cout<<"CurrentL = "<<leftCurrent<<std::endl;
      std::cout<<"ErrorR = "<<rightError<<std::endl;
      std::cout<<"ErrorL = "<<leftError<<std::endl;
      std::cout<<"prevErrorL = "<<prevLeftError<<std::endl;
      std::cout<<"prevErrorR = "<<prevRightError<<std::endl;
      std::cout<<"powL = "<<leftPut<<std::endl;
      std::cout<<"powR = "<<rightPut<<std::endl;
