...
public:
  ...
  void CF() { Clamp.set(true); }// closes clamp without delay 

  void OF() { Clamp.set(false); }// opens clamp without delay 
};
...
public:
  ...
  void OF() {// opens bL without delay
    bL.set(false);

    bLOff = true;
  }
  void CF() {// closes bL without delay
    bL.set(true);
