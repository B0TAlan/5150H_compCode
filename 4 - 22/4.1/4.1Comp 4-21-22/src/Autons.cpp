...
void rightMid(){// Matt
  ...
  clamp.Cloes();
  lift.Idle(60, false);
  robit.customPivot(105, .3, 0.0002, 0.00004, 11, left, false);
  robit.customDrive(-4, .1, .06, .001, 4);
  //robit.customPivot(115, .2, 0.0002, 0.0003, 8);
  bL.Open();
  robit.customDrive(-15, .1, .06, .001, 6);
  bL.Close();
  lift.Idle(75, false);
  robit.customPivot(145, .3, 0.0002, 0.00004, 8);
  robit.Drive(34, 8);
  bL.Open();
...
void right40(){
  ...
  clamp.Open();
  robit.customDrive(-4, .1, .06, .001, 4);
  robit.customPoint(245, .23, .01, .00004, 6);
  bL.Open();
  //robit.Drive(-17.5, 6);
