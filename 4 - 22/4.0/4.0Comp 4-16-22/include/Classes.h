...
public:
  ...
  void customPivot(float heading, float kp, float kd, float ki, float Volts, vex::turnType Dir);
  void Point(float heading, float Volts);
  void Pivot(float heading, float Volts, vex::turnType Dir);
  void turnFor(float amount, float Volts, bool Point, vex::turnType Dir);
};
