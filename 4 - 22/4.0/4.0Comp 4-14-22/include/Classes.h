...
public:
  ...
  void customPivot(float heading, float kp, float kd, float ki, vex::turnType Dir);
  void Point(float heading, float kp);
  void Pivot(float heading, float kp, vex::turnType Dir);
  void turnFor(float amount, float kp, bool Point, vex::turnType Dir);
};
