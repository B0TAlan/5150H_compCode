...
//---------------------------------------------------- voids ---------------------------------------------------------//
 //tank forwards
  ...
  void pushP(){
    clampP.set(true);
    std::cout<<"pushign the P"<<std::endl;
  }
  void noP(){
    clampP.set(false);
    std::cout<<"no p to be pushed"<<std::endl;
  }
  void pringSet(){
    rp = false;
    if (Pring == 1){
...
//---------------------------------------------------------------------------//
 ...
 void usercontrol(void) {
   ...
   //pringON();
   std::cout<<end1.position(rotationUnits::rev)<<std::endl;
   //std::cout<<end2.position(rotationUnits::deg)<<std::endl;
   ...
   while (1) {
    ...
    /* if (Arcade == false){
     ...
     //call back to run a void when button is presed
       ...
       Controller1.ButtonL2.pressed(pushP);
       Controller1.ButtonL1.pressed(noP);
       ...
       Controller1.ButtonA.pressed(wscreen);
