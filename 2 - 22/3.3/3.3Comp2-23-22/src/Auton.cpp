...
void Skills(){
  ...
  driveBase.turnToHeading(92, rotationUnits::deg);// turn to aline with next mgoal
  bL.set(false);// makes sure the back lift is open
  ...
  Clamp.set(false);// open clamp to balnace mgoal 
